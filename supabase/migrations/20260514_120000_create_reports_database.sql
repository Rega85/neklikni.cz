...
DROP TRIGGER IF EXISTS trg_reporters_updated_at ON public.reporters;
...
DROP TRIGGER IF EXISTS trg_claim_subscriptions_updated_at ON public.claim_subscriptions;
CREATE TRIGGER trg_claim_subscriptions_updated_at
  BEFORE UPDATE ON public.claim_subscriptions
  FOR EACH ROW EXECUTE FUNCTION public.reports_set_updated_at();

DROP TRIGGER IF EXISTS trg_claim_responses_updated_at ON public.claim_responses;
...
DROP TRIGGER IF EXISTS trg_incidents_refresh_trust_score ON public.incidents;
...
DROP TRIGGER IF EXISTS trg_incidents_increment_stats ON public.incidents;
