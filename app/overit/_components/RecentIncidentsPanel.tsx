 ...
 * (viz OveritClient — `animate-fade-up`).
 *
 * Prázdný `incidents` (zatím žádná nahlášení) se řeší v komponentě
 * samotné, ne odmítnutím vykreslení — panel má vždy stejnou kostru,
 * nikdy prázdnou díru.
 *
    ...
    <div data-testid="recent-incidents-panel" className="surface-card p-6 space-y-4">
      ...
      {incidents.length === 0 ? (
        <p className="text-sm text-muted-foreground leading-relaxed">
          Zatím žádná nová nahlášení — databáze se plní průběžně. Zkontroluj podezřelou zprávu vlevo.
        </p>
      ) : (
