      ...
      <div className="max-w-3xl mx-auto space-y-10">
        ...
        <section className="space-y-4">
          ...
          <ul className="space-y-2 text-slate-400 text-sm">
            ...
            <li className="flex gap-2"><span className="text-purple-400">→</span> Výmaz údajů (&bdquo;právo být zapomenut&ldquo;)</li>
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-bold text-purple-400">8. Komunitní databáze nahlášených podezření</h2>
          <p className="text-slate-300 leading-relaxed">
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-bold text-purple-400">9. Údaje o nahlášených osobách (třetích stranách)</h2>
          <p className="text-slate-300 leading-relaxed">
          ...
          <ul className="space-y-2 text-slate-400 text-sm">
            <li className="flex gap-2"><span className="text-purple-400">→</span> <strong className="text-white">Identifikátory subjektu</strong> — telefonní číslo, e-mailová adresa, číslo bankovního účtu, odkaz na profil na platformě (Vinted, Facebook Marketplace, Bazoš apod.)</li>
            <li className="flex gap-2"><span className="text-purple-400">→</span> <strong className="text-white">Popis nahlášeného podezření</strong> — text vložený nahlašovatelem (datum, platforma, kategorie, částka, okolnosti)</li>
            <li className="flex gap-2"><span className="text-purple-400">→</span> <strong className="text-white">Důkazní materiály</strong> — screenshoty komunikace nebo inzerátů nahrané nahlašovatelem</li>
            <li className="flex gap-2"><span className="text-purple-400">→</span> <strong className="text-white">Odvozené údaje</strong> — agregovaný počet nahlášení, kategorie, časové rozpětí</li>
          </ul>
          <p className="text-slate-400 text-sm leading-relaxed">
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-bold text-purple-400">10. Zdroj údajů</h2>
          <p className="text-slate-300 leading-relaxed">
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-bold text-purple-400">11. Právní základ — oprávněný zájem</h2>
          <p className="text-slate-300 leading-relaxed">
          ...
          <ul className="space-y-2 text-slate-400 text-sm">
            <li className="flex gap-2"><span className="text-purple-400">→</span> veřejně pouze <strong className="text-white">maskované</strong> identifikátory, nikdy plná jména ani plné údaje</li>
            <li className="flex gap-2"><span className="text-purple-400">→</span> každé nahlášení prochází <strong className="text-white">manuální kontrolou</strong> před zveřejněním — nezveřejňujeme automaticky</li>
            <li className="flex gap-2"><span className="text-purple-400">→</span> záznam je vždy označen jako <strong className="text-white">nepotvrzené nahlášení</strong>, nikoli prokázaný fakt</li>
            <li className="flex gap-2"><span className="text-purple-400">→</span> dotčená osoba má právo <strong className="text-white">námitky</strong>, opravy a výmazu (viz bod 13)</li>
            <li className="flex gap-2"><span className="text-purple-400">→</span> omezená <strong className="text-white">doba uchování</strong> (viz bod 12)</li>
          </ul>
        </section>

        <section className="space-y-4">
          <h2 className="text-xl font-bold text-purple-400">12. Doba uchování nahlášení</h2>
          <p className="text-slate-300 leading-relaxed">
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-bold text-purple-400">13. Práva nahlášené osoby a mechanismus námitky (Notice &amp; Takedown)</h2>
          <p className="text-slate-300 leading-relaxed">
          ...
          <ul className="space-y-2 text-slate-400 text-sm">
            <li className="flex gap-2"><span className="text-purple-400">→</span> záznam můžeme <strong className="text-white">dočasně skrýt</strong> po dobu posouzení,</li>
            <li className="flex gap-2"><span className="text-purple-400">→</span> námitku posoudíme a vyrozumíme vás <strong className="text-white">bez zbytečného odkladu, nejpozději do 14 dnů</strong>,</li>
            <li className="flex gap-2"><span className="text-purple-400">→</span> je-li důvodná, záznam <strong className="text-white">odstraníme nebo opravíme</strong>.</li>
          </ul>
          <p className="text-slate-400 text-sm leading-relaxed">
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-bold text-purple-400">14. Zpracování bezpečnostních a auditních údajů</h2>
          <p className="text-slate-300 leading-relaxed">
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-bold text-purple-400">15. Odpovědnost za obsah nahlášení</h2>
          <p className="text-slate-300 leading-relaxed">
