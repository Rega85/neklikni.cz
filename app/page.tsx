...
export default function Home() {
  ...
  return (
    <main className="flex flex-col items-center px-6 pt-12 relative min-h-screen">
          ...
          <div className="bg-slate-900 border border-purple-500/50 shadow-2xl shadow-purple-500/20 px-6 py-4 rounded-2xl flex items-start gap-4 max-w-md">
            ...
            <div>
              ...
              <p className="text-sm text-slate-400">
                Rozpoznávání podvodů přímo ze screenshotů ladíme. Brzy bude dostupné exkluzivně pro tarify <span className="text-purple-400 font-bold">BASIC</span> a <span className="text-purple-400 font-bold">PRO</span>.
              </p>
            </div>
          </div>
        </div>
