    ...
    <div className="min-h-screen bg-slate-950 text-white flex flex-col items-center py-20 px-6">
      ...
      <div className="grid md:grid-cols-3 gap-8 max-w-6xl w-full">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-3xl p-8 flex flex-col">
          ...
          <button onClick={() => handleCheckout("easy")} disabled={disabled} className="w-full py-4 rounded-xl font-bold bg-slate-800 hover:bg-slate-700 transition-colors disabled:opacity-60">
        ...
        <div className="bg-gradient-to-b from-blue-900/40 to-slate-900 border border-blue-500/50 rounded-3xl p-8 flex flex-col relative transform md:-translate-y-4 shadow-2xl shadow-blue-900/20">
          ...
          <button onClick={() => handleCheckout("basic")} disabled={disabled} className="w-full py-4 rounded-xl font-bold bg-blue-600 hover:bg-blue-500 transition-colors shadow-lg shadow-blue-500/25 disabled:opacity-60">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-3xl p-8 flex flex-col">
          ...
          <button onClick={() => handleCheckout("pro")} disabled={disabled} className="w-full py-4 rounded-xl font-bold bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-500 hover:to-blue-500 transition-colors shadow-lg shadow-purple-500/25 disabled:opacity-60">
