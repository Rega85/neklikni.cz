...
'@
$header | Out-File -FilePath "app\components\Header.tsx" -Encoding UTF8
Write-Host "Header.tsx zapsán" -ForegroundColor Green

# Ověření
$check = Select-String -Path "app\components\Header.tsx" -Pattern "NEKLIKNI.CZ"
if ($check) { Write-Host "✓ NEKLIKNI.CZ nalezeno v souboru" -ForegroundColor Green }
else { Write-Host "✗ CHYBA - NEKLIKNI.CZ nenalezeno!" -ForegroundColor Red }
